...
class OKSLoss(nn.Module):
    def __init__(self,
        ...
        if num_keypoints == 17:
            ...
            # Generic 4-corner objects (pallets, signs, plates, …): uniform OKS
            # weighting since corners are interchangeable in scale sensitivity.
            ...
            # Generic fallback: uniform sigmas. Override via subclass if
            # dataset-specific values are known.
