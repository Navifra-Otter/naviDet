...
from navidet.model.utils import get_activation
...
class RepNCSPELAN4(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, n=3,
        ...
        # `csp_type='csp2'` swaps to CSPLayer2; any other value keeps the
        # module-level CSPLayer. Bind explicitly to avoid Python treating
        # CSPLayer as an unbound local when the if-branch is not taken.
        _CSPLayer = CSPLayer2 if csp_type == 'csp2' else CSPLayer
        self.cv2 = nn.Sequential(_CSPLayer(c3//2, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock))
        self.cv3 = nn.Sequential(_CSPLayer(c4, c4, n, 1, bias=bias, act=act, bottletype=VGGBlock))
